...
namespace WindowsFormsApp1
{
    ...
    {
        CategoryMethodDAL DAL_DanhMuc = new CategoryMethodDAL();
        ...
        public DataTable loadData()
        {
            ...
            List<danh_muc> dm = DAL_DanhMuc.loadDanhMucCap1();
            foreach (var d in dm)
            {
        ...
        public DataTable loadDataDanhMucCon(string idParent)
        {
            ...
            List<danh_muc> dm = DAL_DanhMuc.loadDanhMucChild(idParent);
            foreach (var d in dm)
            {
                dt.Rows.Add(d._id, d.ten_danh_muc, d.danh_muc_cha_id, d.anh_nen);
            }
        ...
        {
            List<danh_muc> rs = DAL_DanhMuc.loadData();
            DataTable dt = new DataTable();
            dt.Columns.Add("ID", typeof(string));
            dt.Columns.Add("Tên danh mục", typeof(string));
            foreach (var d in rs)
        ...
        private void btn_GoBack_Click(object sender, EventArgs e)
        {
            ...
            List<danh_muc> rs = DAL_DanhMuc.loadDanhMucByID(id);
            if (rs.Count > 0)
            {
        ...
        private void btn_Them_Click(object sender, EventArgs e)
        {
            ...
            danh_muc newDM = new danh_muc(ten, idCha, anhNen);
        ...
        private void btn_Sua58_Click(object sender, EventArgs e)
        {
            ...
            string anhNen = (string)ptb_HinhAnh.Tag;
            danh_muc updateDM = new danh_muc(id, ten, idCha, anhNen);
